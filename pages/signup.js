        ...
        <div className="login flex justify-center border-2 bg-white border-gray-300 shadow-md rounded-sm w-1/4 my-9 mx-auto">
          ...
          <p className="text-3xl pb-3 font-normal">Create Account</p>
            <div className="flex flex-col pb-5">
              ...
              <input type="text" id="client-n" placeholder='First and last name' className="p-1 shadow-inner text-gray-600 text-base border outline-none focus:border-green-700 border-gray-300" />
            </div>
            <div className="flex flex-col pb-5">
              <label htmlFor="client-m" className="text-base font-normal pl-1 pb-1">Mobile number</label>
              <input type="text" id="client-m" placeholder='Mobile number' className="p-1 shadow-inner text-gray-600 text-base border outline-none focus:border-green-700 border-gray-300" />
            </div>
            <div className="flex flex-col pb-5">
            ...
            <div className="flex flex-col pb-5">
              ...
              <input type="text" id="client-l" placeholder='At least 6 characters' className="p-1 shadow-inner text-gray-600 text-base border outline-none focus:border-green-700 border-gray-300" />
            </div>
