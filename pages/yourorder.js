  ...
  return (
    <div className='containerr h-screen catoBack flex relative'>
      ...
      <div className="gotoHome right-10 sersbtn top-10 fixed cursor-pointer font-bold text-4xl">
        {!isSmallScreen && <Link href={'/'}><a><div className="flex cursor-pointer justify-center items-center"><button className='rounded-full bg-red-900 text-base px-12 mt-8 py-3 hover:bg-white text-white hover:text-gray-800 border transition-all border-red-800'>Go To Back</button></div></a></Link>}
