      ...
      <div className="flex justify-around py-20 relative">
        <div className="left">
          ...
          <div className="contact flex flex-col">
            <input type="text" id="client-n" placeholder="Your Name" className="p-3 outline-none focus:border-green-700 mb-5 input-bck text-gray-600 text-base border border-gray-200" />
            <input type="text" id="client-e" placeholder="Your Email / Mobile No" className="p-3 outline-none focus:border-green-700 mb-5 input-bck text-gray-600 text-base border border-gray-200"  />
            <textarea name="comment" id="client-m" placeholder="Message" cols="57" rows="5" className="p-3 resize-none outline-none focus:border-green-700 mb-5 input-bck text-gray-600 border text-base border-gray-200" />
