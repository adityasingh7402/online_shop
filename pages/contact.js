  ...
  return (
    <div>
      <div className="flex justify-around mt-20 relative">
        <div className="left">
          <p className='text-5xl text-gray-900 pb-16'>WE'RE READY, LET'S TALK.</p>
          <div className="contact flex flex-col">
            ...
            <button className='font-medium rounded-full bg-green-700 w-52 px-10 py-4 hover:bg-white border transition-all border-green-700'><h6>SEND MESSAGE</h6></button>
          </div>
        </div>
        <div className="right">
