      ...
      <section className="flex flex-row">
        ...
        <div className="product-side w-90 mx-auto">
          ...
          <div className="product-item grid grid-cols-5  productsIt gap-3 my-5 justify-center items-center">
            {products.map((item) => {
              return (
                  <div key={item._id} className="product-box relative h-36 productSize hover:bg-gray-50 bg-white flex flex-col items-center justify-center border-2 rounded-sm tranAnimaS shadow-sm hover:shadow-xl hover:border-gray-200 border-gray-100 cursor-pointer">
                    <div className="product-text text-left self-start w-full pl-3">
                      ...
                      <div className="product-price flex justify-between items-center">
                        <div className="div">
                          ...
                          {item.availableQty == 0 && <p className="text-base text-gray-900 font-medium pb-1">Out of Stock!</p>}
                        </div>
